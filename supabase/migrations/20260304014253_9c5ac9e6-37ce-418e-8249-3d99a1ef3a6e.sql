...
-- Update purchase_service to use last_seen_at (5 min window) instead of modem status column
-- This prevents chips from becoming unavailable during brief sync gaps
...
BEGIN
  ...
  -- Find available chip: use last_seen_at within 5 minutes instead of status column
  -- This prevents chips from going unavailable during sync gaps
